...
export type InputEntries = MessageInputEntry | FunctionResultEntry | ToolExecutionEntry | FunctionCallEntry | MessageOutputEntry | AgentHandoffEntry;
/** @internal */
export declare const InputEntries$inboundSchema: z.ZodType<InputEntries, z.ZodTypeDef, unknown>;
/** @internal */
export type InputEntries$Outbound = MessageInputEntry$Outbound | FunctionResultEntry$Outbound | ToolExecutionEntry$Outbound | FunctionCallEntry$Outbound | MessageOutputEntry$Outbound | AgentHandoffEntry$Outbound;
/** @internal */
